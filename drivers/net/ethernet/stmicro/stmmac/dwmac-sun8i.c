...
static int sun8i_adjust_link(struct stmmac_priv *priv)
{
	...
	ctrl = readl(priv->ioaddr + EMAC_BASIC_CTL0);
	...
	writel(ctrl, priv->ioaddr + EMAC_BASIC_CTL0);
	return new_state;
}
